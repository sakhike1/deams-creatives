<template>
  ...
  <div
    ...
    class="max-w-[85rem] bg-gradient-to-r from-gray-100 to-gray-300 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto"
  >
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      <div class="max-w-2xl lg:max-w-5xl mx-auto">
        ...
        >
          <!-- Card -->
          <div
            class="flex flex-col rounded-xl p-4 sm:p-6 lg:p-8 dark:border-gray-700"
          >
            <h2
              class="mb-8 text-xl font-semibold text-blue-300 dark:text-gray-200"
            >
              Fill in the form
            </h2>

            <form
              action="https://formeezy.com/api/v1/forms/63b2b8aa9e4ddf0008515d85/submissions"
              method="POST"

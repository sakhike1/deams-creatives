<template>
    ...
    <section class="py-24 bg-gray-200 overflow-hidden">
        <!-- Card Blog -->
    ...
    <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
      ...
      <div class="text-center">
        <p class="text-xs font-semibold text-gray-500 tracking-wide uppercase mb-3 dark:text-gray-200">
          Join deams the winning team and be part of the winning team 
        </p>
        <h1 class="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight dark:text-gray-200">
          We believe in investing in talent  <span class="text-blue-500">Join deams </span>
        </h1>
      </div>
      <!-- End Title -->
      ...
      <!-- Form -->
      <form>
        <div class="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border rounded-lg shadow-lg shadow-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:shadow-gray-900/[.2]">
          <div class="pb-2 sm:pb-0 sm:flex-[1_0_0%]">
            ...
            <input type="text" id="hs-hero-name-1" class="py-3 px-4 block w-full border-transparent rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 sm:p-4 dark:bg-gray-800 dark:border-transparent dark:text-gray-400" placeholder="Your name">
          </div>
          <div class="pt-2 sm:pt-0 sm:pl-3 border-t border-gray-200 sm:border-t-0 sm:border-l sm:flex-[1_0_0%] dark:border-gray-700">
            ...
            <input type="email" id="hs-hero-email-1" class="py-3 px-4 block w-full border-transparent rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 sm:p-4 dark:bg-gray-800 dark:border-transparent dark:text-gray-400" placeholder="Your name">
          </div>
          <div class="pt-2 sm:pt-0 grid sm:block sm:flex-[0_0_auto]">
            <nuxt-link class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm sm:p-4 dark:focus:ring-offset-gray-800" :to="{ path: '/JobForm' }">
              Get started
            </nuxt-link>
          </div>
        </div>
      ...
      <div class="hidden absolute top-2/4 left-0 transform -translate-y-2/4 -translate-x-40 md:block lg:-translate-x-80" aria-hidden="true">
        <svg class="w-20 h-auto" width="717" height="653" viewBox="0 0 717 653" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="hidden absolute top-2/4 right-0 transform -translate-y-2/4 translate-x-40 md:block lg:translate-x-80" aria-hidden="true">
        <svg class="w-52 h-auto" width="1115" height="636" viewBox="0 0 1115 636" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<!-- End Hero -->
      ...
      <div class="sm:order-1">
        ...
        <!-- <h2 class="text-2xl font-bold md:text-3xl lg:text-4xl lg:leading-tight xl:text-5xl xl:leading-tight text-gray-800 dark:text-gray-200">
          <a class=" text-gray-500 dark:hover:text-white" href="#">
            Join the amazing team and be part of our story 
          </a>
        </h2> -->
  ...
  <div class="text-center mb-20">
          ...
          <div class="md:max-w-6xl mx-auto m-20">

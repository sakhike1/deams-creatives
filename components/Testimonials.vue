  ...
  <div class="overflow-hidden bg-gradient-to-r from-gray-100 to-gray-300">
    ...
    >
      ...
      <div class="max-w-2xl w-3/4 lg:w-1/2 mb-6 sm:mb-10 md:mb-16">
        <h2
          class="text-2xl sm:text-3xl lg:text-4xl text-gray-400 font-semibold"
        >
          Loved by business and individuals
          <span class="text-blue-300"> across the globe </span>
        </h2>
      </div>
      <!-- End Title -->
            ...
            <div class="p-4 bg-blue-100 rounded-b-xl md:px-7">
              <div class="flex items-center">
                ...
                <div class="ml-3">
                  ...
                  <p class="text-xs text-gray-500">Product Manager | Capsule</p>
                </div>
              </div>
            </div>
          </div>
      ...
      >
        ...
        <div>
          ...
          <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-blue-300">
            99.95%
          </p>

<template>
  <!-- Testimonials -->
<div  class="overflow-hidden bg-gradient-to-r from-gray-100 to-gray-300">
    <div  class="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div class="max-w-2xl w-3/4 lg:w-1/2 mb-6 sm:mb-10 md:mb-16">
        <h2 class="text-2xl sm:text-3xl lg:text-4xl text-gray-400 font-semibold">
          Loved by business and individuals <span class="text-blue-300"> across the globe </span>
        </h2>
      </div>
      <!-- End Title -->
  
      <!-- Grid -->
      <div data-aos="slide-up" class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Card -->
        <div class="flex h-auto">
          <div class="flex flex-col bg-white rounded-xl">
            ...
            <div class="p-4 bg-blue-100 rounded-b-xl md:px-7">
      ...
      <div class="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
        <!-- Stats -->
        <div>
          <h4 class="text-lg sm:text-xl font-semibold text-gray-400">Accuracy rate</h4>
          <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-blue-300">99.95%</p>
        ...
        <!-- Stats -->
        <div>
          <h4 class="text-lg sm:text-xl font-semibold text-gray-400">Startup businesses</h4>
          <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-blue-300">2,000+</p>
        ...
        <!-- Stats -->
        <div>
          <h4 class="text-lg sm:text-xl font-semibold text-gray-400">Happy customer</h4>
          <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-blue-300">85%</p>

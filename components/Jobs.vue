<template>
  <section class="py-24 bg-gray-200 overflow-hidden">
        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
            ...
            >
              ...
              >
                We believe in investing in talent
                <span class="text-blue-500">Join deams </span>
              </h1>
            </div>
            <!-- End Title -->
    ...
    <div class="text-center mb-20">
      <div data-aos="slide-up" class="md:max-w-6xl mx-auto m-20">
        <div class="flex flex-wrap -m-3.5 mb-10">
          <div class="w-full hover:scale-95 md:w-1/3 p-3.5">
            <nuxt-link :to="{ path: 'JobForm' }">
              <div
                class="relative p-6 h-full bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 border hover:border-gray-300 rounded-xl"
              >
                <img
                ...
                <div class="relative z-10 flex flex-col justify-between h-full">
                  <div class="mb-24 flex-1">
                    <h3
                      class="mb-2 text-lg font-bold text-gray-300 font-heading leading-snug"
                    >
                      Senior UX Designer
                    </h3>
          ...
          <div class="w-full hover:scale-95 md:w-1/3 p-3.5">
            <nuxt-link :to="{ path: 'JobForm' }">
              <div
                class="relative p-6 h-full bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400 border hover:border-gray-300 rounded-xl"
              >
                <img
                  class="absolute left-0 top-0"
                  src="flaro-assets/images/career/gradient.svg"
          ...
          <div class="w-full hover:scale-95 md:w-1/3 p-3.5">
            <nuxt-link :to="{ path: 'JobForm' }">
              <div
                class="relative p-6 h-full bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 border hover:border-gray-300 rounded-xl shadow-9xl"
              >
                <img
                  class="absolute left-0 top-0"
                  src="flaro-assets/images/career/gradient.svg"
